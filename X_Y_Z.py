...
def get_angles(landmarks):
    ...
    if landmarks:
        ...
        index_tip_z = landmarks[8].z

        # Example mapping function - adjust based on your needs
        thumb_angle = int(thumb_tip_y * 270)  # Adjust mapping for thumb
        index_angle = int(index_tip_y * 270)  # Adjust mapping for index
